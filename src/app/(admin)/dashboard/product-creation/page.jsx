  ...
  return (
    <div className="p-12">
      ...
      <div className="flex gap-x-2 mt-5 [&>div]:p-4 [&>div]:rounded-lg ">
        <div className="w-8/12  flex flex-col gap-y-4  [&>div]:p-3">
          <div className="bg-white flex flex-col gap-y-6 [&>div]:flex [&>div]:flex-col [&>div]:gap-y-2 [&>div>input]:bg-gray-200 [&>div>input]:p-2 [&>div>input]:rounded-sm [&>div>input]:outline-none ">
          ...
          <div className="bg-white">
            ...
            <div className="mt-3 [&>div>input]:outline-none [&>div>input]:bg-gray-200 [&>div>input]:p-2 [&>div>input]:rounded-sm flex flex-col gap-y-3  [&>div]:flex [&>div]:gap-x-3 [&>div]:items-center">
              <div>
        ...
        <div className="w-4/12  flex flex-col gap-y-4  [&>div]:p-4  [&>div]:rounded-lg ">
          <div className="flex flex-col gap-y-6 [&>span]:text-xs [&>span]:text-gray-500 bg-white">
            <p>تصویر محصول</p>
            <span>
          ...
          <div className="bg-white">
            <p>ویژگی ها</p>
            <div className=" mt-4 flex flex-col gap-y-4 [&>div]:flex [&>div]:flex-col [&>div]:gap-y-2 [&>div>input]:bg-gray-200 [&>div>input]:p-2 [&>div>input]:rounded-sm [&>div>input]:outline-none ">
              <div>
