  ...
  return (
    <div className="p-12">
      <div className="grid grid-cols-4 gap-x-3 [&>div]:flex [&>div]:justify-between [&>div]:items-center  [&>div]:p-4 [&>div]:rounded-lg  [&>div>svg]:text-3xl">
        ...
        <div className="bg-yellow-500 text-yellow-100">
          <div>
            <p>2,344</p>
            <p>پاسخ داده شده</p>
          </div>
        ...
        <div className="bg-red-500 text-red-100">
          <div>
            <p>15</p>
            <p>بسته شده</p>
          </div>
            ...
            <tbody className="text-sm">
              {[1, 2, 3].map((item, index) => (
                <tr key={index} className="border-t">
                  ...
                  <td className="p-3 ">
                    <span className="font-semibold bg-green-800  rounded-lg w-fit p-1 text-white">
                      پاسخ داده شده
                    </span>
                  </td>
                  <td className="p-3">
