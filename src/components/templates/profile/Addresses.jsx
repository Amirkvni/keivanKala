            ...
            <div className="border rounded-3xl border-gray-200">
              <div className="flex justify-between items-center  p-3 relative  ">
                ...
                <IoMdMore
                  ...
                  onClick={() => setIsEditMapOpen(address._id)}
                />
                {isEditMapOpen === address._id && (
                  <div className="absolute px-2 group-hover:block left-[2%] top-[70%] [&>div]:flex [&>div]:gap-x-4 [&>div]:items-center [&>div]:cursor-pointer w-42 border-gray-400 rounded-2xl border bg-white">
                    <div
