...
function BlogBox({ blog }) {
  ...
  return (
    <div className="w-[310px] h-[300px] bg-white dark:bg-zinc-800 dark:text-white rounded-lg overflow-hidden p-3 group-hover:border-t-1 group-hover:border-t-green-400 group-hover:border-l-1 group-hover:border-l-green-400">
